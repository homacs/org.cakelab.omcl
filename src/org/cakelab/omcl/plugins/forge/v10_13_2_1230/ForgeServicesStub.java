package org.cakelab.omcl.plugins.forge.v10_13_2_1230;
...
public class ForgeServicesStub extends org.cakelab.omcl.plugins.forge.ForgeServicesStub {
	private static final String SERVICES_PACKAGE = "org.cakelab.omcl.plugins.forge.v10_13_2_1230.migrates";
	...
	public static ForgeServicesStub create(File jar, ServicesListener listener) throws StubException, IOException {
		...
		if (jar.exists()) {
			try {
				classLoader = createURLClassLoader(jar, new String[]{SERVICES_PACKAGE});
