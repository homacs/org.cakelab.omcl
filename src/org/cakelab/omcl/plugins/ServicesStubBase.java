...
public class ServicesStubBase {
	...
	/**
	 * 
	 * @param jarFile Jar file of the plugin.
	...
	protected static URLClassLoader createURLClassLoader(File jarFile, String[] migrates) throws IOException {
		URL myClasspathEntry = Classpath.determineClasspathEntry(ServicesStubBase.class).getUrl();
		URL[] classpath = new URL[]{myClasspathEntry, jarFile.toURL()};
