package org.cakelab.omcl.setup.forge.v11_15_1_1902;
...
public class ForgeSetup extends ForgeSetupBase {
	...
	public void init() throws Throwable {
		...
		case CLIENT:
			...
			forgedJar = new File(librariesDir, "net/minecraftforge/forge/" + mcVer + "-" + forgeVersion + "-" + mcVer + "/" + "forge-" + mcVer + "-" + forgeVersion + "-" + mcVer + ".jar");
	...
	public String createLastVersionId() {
		String mcVer = minecraftClient.getVersion();
		return mcVer + "-forge" + mcVer + "-" + getForgeInternalVersion() + "-" + mcVer;
	}
