package org.cakelab.omcl.setup.forge.v10_13_4_1614;
...
public class ForgeSetup extends ForgeSetupBase {
	...
	public void init() throws Throwable {
		...
		String mcForgeMc = mcVer + "-" + forgeVersion + "-" + mcVer;
		switch (setupParams.type) {
		case CLIENT:
			File forgeVersionDir = new File(versionsDir, forgeVersionId);
			forgedJar = new File(librariesDir, "net/minecraftforge/forge/" + mcForgeMc + "/" + "forge-" + mcForgeMc + ".jar");
	...
	public String createLastVersionId() {
		String mcVer = minecraftClient.getVersion();
		return mcVer + "-Forge" + getForgeInternalVersion() + "-" + mcVer;
	}
